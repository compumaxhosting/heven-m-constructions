...
export default function HomeAdditionsBergenCountyPage() {
  ...
  return (
    <>
      <Helmet>
        <title>Whole-Home Additions in Bergen County, NJ | Haven M</title>
        <meta name="description" content="Planning a whole-home addition in Bergen County, NJ? Haven M Construction provides custom design-build solutions for more space, comfort and value." />
        ...
        <link rel="canonical" href="https://www.havenmconstruction.com/whole-home-additions-bergen-county-nj" />
        <meta name="robots" content="index,follow" />
        <meta name="theme-color" content="#ffffff" />
        <meta property="og:type" content="website" />
        <meta property="og:title" content="Whole-Home Additions in Bergen County, NJ | Haven M" />
        <meta property="og:description" content="Planning a whole-home addition in Bergen County, NJ? Haven M Construction provides custom design-build solutions for more space, comfort and value." />
        <meta property="og:url" content="https://www.havenmconstruction.com/whole-home-additions-bergen-county-nj" />
        ...
        <meta property="og:image:alt" content="Whole-home additions in Bergen County, NJ by Haven M Construction" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Whole-Home Additions in Bergen County, NJ | Haven M" />
        <meta name="twitter:description" content="Planning a whole-home addition in Bergen County, NJ? Haven M Construction provides custom design-build solutions for more space, comfort and value." />

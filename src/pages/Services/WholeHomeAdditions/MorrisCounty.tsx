...
export default function HomeAdditionsMorrisCountyPage() {
  const [openFaq, setOpenFaq] = React.useState<number | null>(0);

  return (
    <>
      <Helmet>
        <title>Whole-Home Additions in Morris County, NJ | Haven M</title>
        <meta name="description" content="Planning a whole-home addition in Morris County, NJ? Haven M Construction provides custom design-build solutions for more space, comfort, and lasting value." />
        ...
        <link rel="canonical" href="https://www.havenmconstruction.com/whole-home-additions-morris-county-nj" />
        <meta name="robots" content="index,follow" />
        <meta name="theme-color" content="#ffffff" />
        <meta property="og:type" content="website" />
        <meta property="og:title" content="Whole-Home Additions in Morris County, NJ | Haven M" />
        <meta property="og:description" content="Planning a whole-home addition in Morris County, NJ? Haven M Construction provides custom design-build solutions for more space, comfort, and lasting value." />
        <meta property="og:url" content="https://www.havenmconstruction.com/whole-home-additions-morris-county-nj" />
        ...
        <meta property="og:image:alt" content="Whole-home additions in Morris County, NJ by Haven M Construction" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Whole-Home Additions in Morris County, NJ | Haven M" />
        <meta name="twitter:description" content="Planning a whole-home addition in Morris County, NJ? Haven M Construction provides custom design-build solutions for more space, comfort, and lasting value." />
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-8 relative z-10">
          <motion.div initial="hidden" animate="visible" variants={staggerContainer} className="max-w-4xl">
            ...
            <motion.p variants={fadeIn} className="text-[18px] sm:text-[22px] leading-[1.6] text-forest-deep/80 font-light mb-8">
              Need more room without leaving Morris County? A well-planned home addition can expand your living space while making your existing home more comfortable, functional, and adaptable.
            </motion.p>

            <motion.p variants={fadeIn} className="text-[16px] sm:text-[18px] leading-[1.7] text-forest-deep/75 font-light">
              We provide residential home addition services throughout Morris County, NJ, including kitchen expansions, family rooms, bedrooms, primary suites, home offices, and second-story additions.
            </motion.p>
          ...
          <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-16">
            <div className="lg:col-span-6">
              ...
              <div className="space-y-6 text-[17px] leading-[1.8] text-linen/70 font-light">
                <motion.p variants={fadeIn}>
                  The right addition starts with understanding the existing home and the reason you need more space. Design considerations can include layout, architecture, natural light, circulation, structural requirements, and how the new space connects to the rest of the house.
                </motion.p>
              </div>
            </div>
            ...
            <div className="lg:col-span-6">
              <motion.div variants={fadeIn} className="bg-white/5 backdrop-blur-sm p-8 sm:p-10 rounded-[24px] sm:rounded-[32px] border border-white/10 shadow-sm mt-6 lg:mt-12">
                <h3 className="font-display text-2xl text-linen mb-6">An Addition That Belongs to the Home</h3>
                <p className="text-[15px] leading-[1.7] text-linen/70 font-light mb-6">A quality addition should feel intentional—not attached as an afterthought. Rooflines, windows, exterior materials, floor elevations, finishes, lighting, HVAC, plumbing, and electrical systems all need to work together with the existing house.</p>
                <p className="text-[15px] leading-[1.7] text-linen font-medium text-terracotta">The objective is more than additional square footage. It's better space that improves how the entire home functions.</p>
              </motion.div>
            </div>
          </div>
        </motion.div>
        ...
        <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-100px" }} variants={staggerContainer} className="bg-forest rounded-[32px] sm:rounded-[40px] p-8 sm:p-16 lg:p-24 relative overflow-hidden shadow-2xl w-full">
          ...
          <div className="relative z-10">
            ...
            <motion.h2 variants={fadeIn} className="font-display text-[clamp(2.5rem,5vw,4.5rem)] leading-[1.05] text-linen mb-16 tracking-[-0.02em] max-w-2xl">
              Popular Home Addition Options <span className="italic text-terracotta">in Morris County</span>
            </motion.h2>

            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {[
                { title: 'Kitchen Expansions', desc: 'Add workspace, storage, dining space, and better connections to living areas.' },
                { title: 'Family Room Additions', desc: 'Create comfortable space for everyday living and entertaining.' },
                { title: 'Primary Suite Additions', desc: 'Add a private bedroom, bathroom, and closet area.' },
                { title: 'Bedroom Additions', desc: 'Provide additional space for family members or guests.' },
                { title: 'Home Office Additions', desc: 'Create a dedicated, functional workspace.' },
                { title: 'Second-Story Additions', desc: 'Add living space when expanding outward isn\'t practical.' },
              ].map((step, i) => (
          ...
          <div className="max-w-4xl mx-auto relative z-10">
            <motion.div variants={fadeIn} className="text-center mb-12">
              <motion.h2 variants={fadeIn} className="font-display text-4xl sm:text-5xl text-forest mb-6 tracking-[-0.02em]">
                What to Consider <span className="italic text-terracotta">Before Building</span>
              </motion.h2>
              <motion.p variants={fadeIn} className="text-[18px] leading-[1.8] text-forest-deep/80 font-light max-w-3xl mx-auto">
                Before starting a home addition, consider:
              </motion.p>
            </motion.div>
            ...
            <motion.div variants={fadeIn} className="grid grid-cols-1 sm:grid-cols-2 gap-x-12 gap-y-4 max-w-3xl mx-auto mb-8">
              {[
                ...
                'Is building outward or upward better for your property?',
                'How will the new space connect to existing rooms?',
                'What structural changes may be necessary?',
                'What zoning and permitting requirements apply?',
                'How will construction affect your household?',
                'Can the design accommodate future needs?'
              ].map((item, i) => (
            ...
            <motion.div variants={fadeIn} className="text-center text-[15px] text-forest-deep/60 italic">
              Requirements can vary among Morris County municipalities, so every property should be evaluated individually.
            </motion.div>
          </div>
        </motion.div>
        ...
        <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-100px" }} variants={staggerContainer} className="max-w-4xl mx-auto flex flex-col gap-12">
          ...
          <motion.div variants={fadeIn} className="text-center">
            ...
            <p className="text-[18px] leading-[1.8] text-forest-deep/80 font-light mt-6 max-w-2xl mx-auto">
              Planning a home addition is a major decision. Here are answers to some of the most common questions we receive from homeowners in Morris County.
            </p>
          </motion.div>

          <div className="space-y-4">
            {[
              { q: 'How much does a home addition cost in Morris County?', a: 'Costs depend on project size, design, structural requirements, finishes, site conditions, and complexity. A property-specific evaluation is needed for an accurate scope and estimate.' },
              { q: 'Can I add a second story to my Morris County home?', a: 'Possibly. The existing structure, foundation, roof configuration, property conditions, and applicable local requirements should be evaluated before planning the addition.' },
              { q: 'Is an addition better than moving?', a: 'If you like your location but need more usable space, an addition may be a practical alternative to moving. The right choice depends on your property, goals, budget, and long-term plans.' },
              { q: 'Do home additions require permits?', a: 'Requirements vary by municipality and project. Zoning and permit requirements should be confirmed before construction begins.' },
            ].map((faq, i) => {
        ...
        <div className="mx-auto max-w-4xl px-4 sm:px-8 text-center relative z-10">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={staggerContainer}>
            <motion.h2 variants={fadeIn} className="font-display text-[clamp(2.5rem,6vw,4.5rem)] text-linen mb-6 leading-[1.05] tracking-[-0.02em]">
              Plan Your Morris County <br className="hidden sm:block" /><span className="italic text-terracotta">Home Addition</span>
            </motion.h2>
            <motion.div variants={fadeIn} className="space-y-6 text-[18px] sm:text-[20px] leading-[1.7] text-linen/70 mb-10 max-w-2xl mx-auto font-light">
              <p>Create more space while staying in the community you already know and love.</p>
              <p>Contact us to discuss your residential home addition in Morris County, NJ.</p>
            </motion.div>

        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-8 relative z-10">
          <motion.div initial="hidden" animate="visible" variants={staggerContainer} className="max-w-4xl">
            ...
            <motion.p variants={fadeIn} className="text-[18px] sm:text-[22px] leading-[1.6] text-forest-deep/80 font-light mb-6">
              Every construction dollar should contribute to the project's intended outcome. Haven M Construction provides value engineering in Passaic County, NJ for owners and project teams looking for practical ways to evaluate construction costs, materials, methods, constructability, and long-term performance.
            </motion.p>
        ...
        <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-100px" }} variants={staggerContainer} className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-start">
          ...
          <motion.div variants={fadeIn} className="bg-white/50 backdrop-blur-sm p-8 sm:p-10 rounded-[24px] sm:rounded-[32px] border border-white shadow-sm">
            ...
            <p className="text-[15px] leading-[1.7] text-forest-deep/80 font-light mb-4">
              Haven M Construction does not treat value engineering as a catalog of inexpensive replacements. Instead, alternatives should be evaluated against the project's actual objectives.
            </p>
        ...
        <div className="mx-auto max-w-4xl px-4 sm:px-8 text-center relative z-10">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={staggerContainer}>
            ...
            <motion.div variants={fadeIn} className="space-y-6 text-[18px] sm:text-[20px] leading-[1.7] text-linen/70 mb-10 max-w-2xl mx-auto font-light">
              <p>Haven M Construction serves construction projects throughout Passaic County, including Paterson, Clifton, Wayne, Passaic, West Milford, Little Falls, Totowa, Pompton Lakes, and surrounding communities, depending on project requirements.</p>
              ...
              <p>For value engineering in Passaic County, NJ, contact Haven M Construction to discuss your project's scope, budget, design, and construction objectives.</p>
            </motion.div>

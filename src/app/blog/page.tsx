...
import { ArrowLeft, ArrowRight, Calendar, Clock, BookOpen, Share2, Quote, ArrowUpRight } from 'lucide-react';
...
const blogPosts: BlogPost[] = [
  {
    ...
    title: 'Modern Residential Architecture: Finding Harmony in Custom Home Design',
    category: 'Residential',
    date: 'August 12, 2026',
    readTime: '5 min read',
    summary: 'How Haven M Construction blends modern forms with traditional warmth to create timeless custom homes that feel as grounded as they are inspiring.',
  ...
  },
  {
    ...
    date: 'July 28, 2026',
    readTime: '4 min read',
    summary: 'Exploring why a unified design-build approach prevents delays, reduces costs, and protects the integrity of every architectural detail.',
  ...
  },
  {
    ...
    date: 'June 15, 2026',
    readTime: '6 min read',
    summary: 'How bespoke millwork, deliberate lighting design, and premium materials redefine the modern boutique customer experience.',
      ...
      <div className="relative z-10 mx-auto max-w-5xl px-5 sm:px-8">
        {!activePost ? (
          ...
          <>
            {/* Page Header */}
            <div className="mb-16">
              <p className="text-[11px] uppercase tracking-[0.3em] text-clay font-semibold mb-4">Haven M · Studio Journal</p>
          ...
          <article className="max-w-3xl mx-auto">
            ...
            <div className="mt-16 pt-8 border-t border-forest/10 flex items-center justify-between">
              ...
              <button onClick={() => setSelectedPostId(null)} className="text-xs font-mono uppercase tracking-wider text-forest/70 hover:text-terracotta transition-colors">
                ← Return to Journal
              </button>
            </div>
              ...
              <div className="mt-20 pt-14 border-t border-forest/10">
                ...
                >
                  <div className="w-20 h-20 rounded-xl overflow-hidden shrink-0 bg-sand">
                    <img src={nextPost.image} alt={nextPost.title} className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-300" />
                  </div>

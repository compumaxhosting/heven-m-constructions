...
export default function DesignBuildEssexCountyPage() {
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-8 relative z-10">
          <motion.div initial="hidden" animate="visible" variants={staggerContainer} className="max-w-4xl">
            ...
            <motion.h2 variants={fadeIn} className="text-[20px] sm:text-[24px] text-forest font-medium tracking-tight mb-6 leading-snug">
              Integrated Design-Build Construction for Essex County Homes
            </motion.h2>
            ...
            <motion.p variants={fadeIn} className="text-[16px] sm:text-[17px] leading-[1.7] text-forest-deep/75 font-light">
              Whether you are considering a home addition, whole-home renovation, kitchen transformation, or another major residential project, we help connect the planning and construction phases from the beginning.
            </motion.p>
          ...
          <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-16">
            <div className="lg:col-span-6">
              ...
              <motion.h2 variants={fadeIn} className="font-display text-4xl sm:text-5xl text-linen mb-8 tracking-[-0.02em]">
                Design-Build for <br /><span className="italic text-terracotta">Essex County Homeowners</span>
              </motion.h2>
              <div className="space-y-6 text-[17px] leading-[1.8] text-linen/70 font-light">
                <motion.p variants={fadeIn}>
                  A successful renovation starts with understanding both the home and the homeowner's goals.
                </motion.p>
                <motion.p variants={fadeIn}>
                  In Essex County, properties can vary considerably in size, layout, age, and existing construction. That makes early planning particularly important when a project involves changing the footprint, opening walls, adding rooms, or substantially reworking an existing floor plan.
                </motion.p>
              </div>
            </div>
            ...
            <div className="lg:col-span-6">
              <motion.div variants={fadeIn} className="bg-white/5 backdrop-blur-sm p-8 sm:p-10 rounded-[24px] sm:rounded-[32px] border border-white/10 shadow-sm mt-6 lg:mt-12">
                <p className="text-[16px] leading-[1.7] text-linen/90 font-light">
                  Our design-build approach considers the proposed design alongside construction requirements so important decisions can be addressed before construction begins.
                </p>
              </motion.div>
            </div>
          </div>
          ...
          <div className="max-w-4xl mx-auto relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-start">
            <div className="lg:col-span-6">
              <motion.h2 variants={fadeIn} className="font-display text-4xl sm:text-5xl text-forest mb-8 tracking-[-0.02em]">
                What We Can <span className="italic text-terracotta">Help You Plan</span>
              </motion.h2>
              <motion.div variants={fadeIn} className="space-y-6 text-[18px] leading-[1.8] text-forest-deep/80 font-light mb-8">
                <p>Our residential design-build services can include a wide variety of additions, renovations, and structural works to suit your lifestyle.</p>
                <p className="text-[16px] font-medium text-terracotta">The appropriate scope depends on your home, property, and project goals.</p>
              </motion.div>
            </div>
            ...
            <div className="lg:col-span-6">
              <motion.div variants={fadeIn} className="bg-white/60 backdrop-blur-sm p-8 sm:p-10 rounded-[24px] sm:rounded-[32px] border border-white shadow-sm">
                <h3 className="font-display text-2xl text-forest mb-6">Our residential design-build services can include:</h3>
        ...
        <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-100px" }} variants={staggerContainer} className="bg-forest rounded-[32px] sm:rounded-[40px] p-8 sm:p-16 lg:p-24 relative overflow-hidden shadow-2xl w-full">
          ...
          <div className="relative z-10">
            ...
            <motion.h2 variants={fadeIn} className="font-display text-[clamp(2.5rem,5vw,4.5rem)] leading-[1.05] text-linen mb-16 tracking-[-0.02em] max-w-2xl">
              A Coordinated Process <span className="italic text-terracotta">From Idea to Completion</span>
            </motion.h2>

            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {[
                { title: 'Consultation', desc: 'We start by understanding what you want to accomplish, what is not working in your current space, and what you want the finished home to provide.' },
                { title: 'Evaluation & Planning', desc: 'The existing property and proposed scope are reviewed to identify important construction considerations.' },
                { title: 'Design Coordination', desc: 'Your ideas are developed into a practical project plan, including layout, materials, finishes, and construction requirements.' },
                { title: 'Estimating & Pre-Construction', desc: 'The project scope, costs, scheduling, permitting requirements, and construction details are coordinated before work begins.' },
                { title: 'Construction', desc: 'The planned project moves into construction with coordination among the necessary trades and professionals.' },
                { title: 'Final Completion', desc: 'The completed work is reviewed and the project is brought through final completion.' },
              ].map((step, i) => (
        ...
        <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-100px" }} variants={staggerContainer} className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-start">
          <motion.div variants={fadeIn}>
            <h2 className="font-display text-4xl sm:text-5xl text-forest mb-6 tracking-[-0.02em]">
              Why Use <span className="italic text-terracotta">Design-Build?</span>
            </h2>
            <p className="text-[17px] leading-[1.8] text-forest-deep/80 font-light mb-8">
              Design-build can be especially useful for homeowners undertaking projects where design and construction decisions are closely connected. Instead of coordinating separate design and construction processes, homeowners have a more integrated path from concept to completion.
            </p>
            <h3 className="font-display text-2xl text-forest mb-6">Benefits can include:</h3>
            <div className="grid grid-cols-1 gap-y-3 mb-6">
              {[
                'Fewer communication handoffs',
                'Earlier construction input',
                'Better coordination between design and building',
                'More connected budgeting and planning',
                'A clearer overall project process'
              ].map((item, i) => (
          ...
          <motion.div variants={fadeIn} className="bg-white/50 backdrop-blur-sm p-8 sm:p-10 rounded-[24px] sm:rounded-[32px] border border-white shadow-sm">
            <h3 className="font-display text-2xl text-forest mb-6">Home Addition and Remodeling Projects</h3>
            <p className="text-[15px] leading-[1.7] text-forest-deep/80 font-light mb-6">
              If your current Essex County home is in the right location but no longer fits your lifestyle, expanding or remodeling may provide the space you need without moving.
            </p>
            <p className="text-[15px] leading-[1.7] text-forest-deep/80 font-light mb-6">
              Depending on the property, possibilities may include adding living space, improving the kitchen, creating a larger primary suite, or reworking multiple rooms into a more functional layout.
            </p>
            <p className="text-[14px] leading-[1.7] text-forest-deep/70 font-light italic mb-6">
              The best solution starts with the property—not a predetermined design.
            </p>
            <div className="h-px w-full bg-gradient-to-r from-forest/10 to-transparent my-6" />
            <h3 className="font-display text-2xl text-forest mb-4">Local Planning Matters</h3>
            <p className="text-[14px] leading-[1.7] text-forest-deep/80 font-light mb-4">
              A residential construction project may involve zoning, setbacks, building requirements, permits, inspections, and other municipal requirements.
            </p>
            <p className="text-[14px] leading-[1.7] text-forest-deep/60 font-light italic">
              Those requirements can vary by municipality and property. Project-specific planning is therefore important before construction begins.
            </p>
          </motion.div>
        </motion.div>
        ...
        <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-100px" }} variants={staggerContainer} className="max-w-4xl mx-auto flex flex-col gap-12">
          ...
          <motion.div variants={fadeIn} className="text-center">
            ...
            <p className="text-[18px] leading-[1.8] text-forest-deep/80 font-light mt-6 max-w-2xl mx-auto">
              Planning a design-build construction project is a major decision. Here are answers to some of the most common questions we receive from homeowners in Essex County.
            </p>
          </motion.div>

          <div className="space-y-4">
            {[
              { q: 'What does a design-build contractor do?', a: 'A design-build contractor coordinates the design and construction process through an integrated project delivery approach.' },
              { q: 'Is design-build good for home additions?', a: 'Yes. Design-build can be useful for additions because the design, structural requirements, construction methods, and budget can be considered together.' },
              { q: 'Can you remodel an existing Essex County home?', a: 'Yes, depending on the project scope and property. Design-build can work well for major renovations where multiple areas of a home need to be coordinated.' },
              { q: 'How much does design-build cost in Essex County?', a: 'There is no fixed price. Cost depends on the size, design, existing conditions, structural work, materials, mechanical systems, and overall complexity of the project.' },
              { q: 'How do I start a project?', a: 'Begin with a consultation to discuss your property, goals, proposed scope, and priorities.' },
            ].map((faq, i) => {

        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-8 text-center relative z-10">
          <motion.div initial="hidden" animate="visible" variants={staggerContainer} className="max-w-4xl mx-auto">
            ...
            <motion.h1 variants={fadeIn} className="font-display text-[clamp(2.5rem,6vw,5.5rem)] text-forest leading-[1.05] tracking-[-0.02em] mb-8">
              ...
              <span className="italic text-terracotta">Passaic County, NJ</span>
            </motion.h1>
            ...
            <motion.p variants={fadeIn} className="text-[18px] sm:text-[22px] leading-[1.6] text-forest-deep/80 font-light mb-12 max-w-2xl mx-auto">
              Build a Veterinary Facility for Efficient Patient Care
            </motion.p>
          </motion.div>
        </div>
      </section>
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-8 py-12 sm:py-20 space-y-32">
          ...
          <div className="lg:col-span-5">
            <motion.div variants={fadeIn} className="relative">
              ...
              <div className="space-y-6 text-[17px] leading-[1.8] text-forest-deep/80 font-light">
                <p>Veterinary hospitals combine medical treatment, animal handling, diagnostics, surgery, recovery, client service, and administrative work. The construction needs to accommodate all of these functions without making the facility unnecessarily complicated.</p>
                <p>Hevan M Constructions provides veterinary hospital construction and renovation services in Passaic County, NJ, serving veterinary practices from Verona, New Jersey.</p>
                <p className="pt-2 border-t border-forest/10 font-medium text-forest">A veterinary facility should be planned around movement and relationships between spaces.</p>
              </div>
            </motion.div>
          </div>
        ...
        <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-100px" }} variants={staggerContainer} className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-stretch">
          <motion.div variants={fadeIn} className="bg-linen p-10 sm:p-14 rounded-[32px] border border-white shadow-[0_8px_30px_rgb(0,0,0,0.02)] flex flex-col">
            <h2 className="font-display text-4xl text-forest mb-8 tracking-[-0.02em]">
              Examination and <br /><span className="italic text-terracotta">Treatment Areas</span>
            </h2>
            <div className="space-y-5 text-[16.5px] leading-[1.8] text-forest-deep/90 mb-10 flex-grow font-light">
              <p>Clinical rooms need to support veterinary staff without creating unnecessary obstacles.</p>
              <p className="font-medium text-forest pt-2">Construction planning may consider:</p>
              <ul className="grid grid-cols-2 gap-y-3 gap-x-4 mt-4 text-[14.5px]">
                {[
                  'Room dimensions', 'Work surfaces', 'Equipment placement', 'Storage',
                  'Lighting', 'Electrical outlets', 'Plumbing', 'Patient movement',
                  'Staff circulation', 'Cleanable finishes'
                ].map((item, i) => (
            ...
            <div className="pt-8 border-t border-forest/10">
              <p className="text-[14.5px] italic text-forest-deep/80 leading-relaxed text-center">
                The final requirements should be determined by the veterinary practice's operational needs.
              </p>
            </div>
          </motion.div>
          ...
          <motion.div variants={fadeIn} className="bg-sand p-10 sm:p-14 rounded-[32px] border border-white shadow-[0_8px_30px_rgb(0,0,0,0.02)] flex flex-col">
            <h2 className="font-display text-4xl text-forest mb-8 tracking-[-0.02em]">
              Recovery and <br /><span className="italic text-terracotta">Hospitalization Areas</span>
            </h2>
            <div className="space-y-5 text-[16.5px] leading-[1.8] text-forest-deep/90 mb-10 flex-grow font-light">
              <p>If a practice provides hospitalization or recovery services, these areas should be considered as part of the overall patient journey.</p>
              <p className="font-medium text-forest pt-2">Planning may address:</p>
              <ul className="grid grid-cols-1 sm:grid-cols-2 gap-y-3 gap-x-4 mt-4 text-[14.5px]">
                {[
                  'Access to treatment areas', 'Staff visibility', 'Animal movement',
                  'Storage', 'Cleaning', 'Utilities', 'Separation between different functions',
                  'Equipment placement'
                ].map((item, i) => (
                  <li key={i} className="flex items-center gap-2">
            ...
            <div className="pt-8 border-t border-forest/10">
              <p className="text-[14.5px] italic text-forest-deep/80 leading-relaxed text-center">
                The facility should support the specific type and volume of care provided.
              </p>
            </div>
          </motion.div>
        </motion.div>
        ...
        <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-100px" }} variants={staggerContainer} className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          <motion.div variants={fadeIn}>
            <h2 className="font-display text-4xl sm:text-5xl text-forest mb-6 tracking-[-0.02em]">
              Coordinating <br/><span className="italic text-terracotta">Veterinary Equipment</span>
            </h2>
            ...
            <ul className="grid grid-cols-1 sm:grid-cols-2 gap-y-4 gap-x-6 text-[15px] text-forest-deep/80 font-light">
              {[
                'Electrical capacity', 'Plumbing', 'Ventilation',
                'Room dimensions', 'Structural needs', 'Access',
          ...
          <motion.div variants={fadeIn} className="bg-white/50 backdrop-blur-sm p-10 rounded-[32px] border border-white shadow-sm">
            <h2 className="font-display text-3xl sm:text-4xl text-forest mb-6 tracking-[-0.02em]">
              Renovating a <br/><span className="italic text-terracotta">Veterinary Practice</span>
            </h2>
            <div className="space-y-4 text-[16.5px] leading-[1.8] text-forest-deep/80 font-light mb-6">
              <p>Renovation can be an alternative to relocating.</p>
              <p>A project might focus on one area or involve a broader facility transformation, such as adding examination rooms, expanding treatment space, improving reception, creating a surgical area, updating flooring, reconfiguring circulation, improving storage, and updating building systems.</p>
              <p className="font-medium text-forest pt-2 border-t border-forest/10">The scope should be based on the existing property's condition and the practice's goals.</p>
            </div>
          </motion.div>
        </motion.div>
        ...
        <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-100px" }} variants={staggerContainer} className="text-center max-w-4xl mx-auto bg-white/40 border border-white rounded-[32px] p-10 sm:p-14">
           <motion.h2 variants={fadeIn} className="font-display text-3xl sm:text-4xl text-forest mb-6 tracking-[-0.02em]">
              Veterinary Hospital Construction Cost
            </motion.h2>
            <motion.div variants={fadeIn} className="text-[17px] leading-[1.8] text-forest-deep/90 font-light text-left">
              <p className="text-center mb-6">The cost of a Passaic County veterinary project depends on the specific property and scope. Common factors include:</p>
              <ul className="grid grid-cols-2 md:grid-cols-3 gap-y-3 gap-x-4 max-w-3xl mx-auto mb-6 text-[14px]">
                {[
                  'Facility size', 'Existing building conditions', 'New construction versus renovation',
                  'Structural work', 'Plumbing', 'Electrical', 'HVAC', 'Clinical room requirements',
                  'Surgical facilities', 'Finishes', 'Millwork', 'Equipment', 'Accessibility', 'Permits and inspections'
                ].map((item, i) => (
                  <li key={i} className="flex items-center gap-2">
              ...
              <p className="text-center text-[15px] italic border-t border-forest/10 pt-6">A detailed scope provides a better foundation for project budgeting than a generic industry price.</p>
            </motion.div>
        </motion.div>
        ...
        <div className="mx-auto max-w-4xl px-4 sm:px-8 text-center relative z-10">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={staggerContainer}>
            <motion.h2 variants={fadeIn} className="font-display text-[clamp(2.5rem,6vw,4.5rem)] text-linen mb-8 leading-[1.05] tracking-[-0.02em]">
              Veterinary Hospital Construction in <br className="hidden sm:block" /><span className="italic text-terracotta">Passaic County, NJ</span>
            </motion.h2>
            <motion.div variants={fadeIn} className="space-y-6 text-[18px] sm:text-[20px] leading-[1.7] text-linen/70 mb-14 max-w-2xl mx-auto font-light">
              ...
              <p>Planning a veterinary clinic, animal hospital, renovation, or expansion? Contact Hevan M Constructions to discuss your project and property.</p>
            </motion.div>

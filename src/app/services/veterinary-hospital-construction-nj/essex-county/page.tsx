        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-8 text-center relative z-10">
          <motion.div initial="hidden" animate="visible" variants={staggerContainer} className="max-w-4xl mx-auto">
            ...
            <motion.h1 variants={fadeIn} className="font-display text-[clamp(2.5rem,6vw,5.5rem)] text-forest leading-[1.05] tracking-[-0.02em] mb-8">
              ...
              <span className="italic text-terracotta">Essex County, NJ</span>
            </motion.h1>
            ...
            <motion.p variants={fadeIn} className="text-[18px] sm:text-[22px] leading-[1.6] text-forest-deep/80 font-light mb-12 max-w-2xl mx-auto">
              Purpose-Built Construction for Veterinary Practices
            </motion.p>
          </motion.div>
        </div>
      </section>
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-8 py-12 sm:py-20 space-y-32">
          ...
          <div className="lg:col-span-5">
            <motion.div variants={fadeIn} className="relative">
              ...
              <div className="space-y-6 text-[17px] leading-[1.8] text-forest-deep/80 font-light">
                <p>A veterinary hospital must bring clinical areas, patient care, staff workflow, equipment, client spaces, and building systems together in one functional environment.</p>
                <p>Hevan M Constructions provides veterinary hospital construction, clinic build-outs, renovations, and facility improvements in Essex County, NJ, from our location in Verona.</p>
                <p>Whether you are developing a new practice or improving an existing facility, construction should begin with a clear understanding of how the space will be used.</p>
              </div>
            </motion.div>
          </div>
        ...
        <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-100px" }} variants={staggerContainer} className="bg-linen rounded-[40px] p-10 sm:p-16 lg:p-24 relative overflow-hidden shadow-sm border border-white">
          <div className="max-w-3xl mx-auto text-center relative z-10">
            ...
            <motion.div variants={fadeIn} className="space-y-6 text-[18px] leading-[1.8] text-forest-deep/80 font-light">
              <p>An existing commercial property can sometimes be converted into a veterinary practice when the building and proposed use are suitable.</p>
              <p>A veterinary build-out may involve interior demolition and reconfiguration, examination rooms, treatment areas, reception, plumbing, electrical systems, lighting, HVAC modifications, flooring and wall finishes, casework and storage, and clinical support spaces.</p>
              <p className="font-medium text-forest/90">Existing conditions should be evaluated before establishing the final scope.</p>
            </motion.div>
          </div>
        </motion.div>
        ...
        <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-100px" }} variants={staggerContainer} className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          <motion.div variants={fadeIn}>
            <h2 className="font-display text-4xl sm:text-5xl text-forest mb-6 tracking-[-0.02em]">
              Construction for <br/><span className="italic text-terracotta">Surgical Spaces</span>
            </h2>
            ...
            <h3 className="font-display text-2xl text-forest mb-6">Planning may include:</h3>
            <ul className="grid grid-cols-1 sm:grid-cols-2 gap-y-4 gap-x-6 text-[15px] text-forest-deep/80 font-light">
              {[
                'Surgical rooms', 'Pre-op areas', 'Recovery',
                'Equipment locations', 'Storage', 'Lighting',
                'Electrical requirements', 'Plumbing', 'Mechanical systems', 'Staff circulation'
              ].map((item, i) => (
          ...
          <motion.div variants={fadeIn} className="bg-white/50 backdrop-blur-sm p-10 rounded-[32px] border border-white shadow-sm">
            ...
            <div className="space-y-4 text-[16.5px] leading-[1.8] text-forest-deep/80 font-light mb-6">
              <p>An established practice may need additional capacity without moving to another property. Renovation can help address issues such as limited examination rooms, inefficient patient flow, insufficient treatment space, outdated finishes, inadequate storage, changing staff requirements, and additional clinical services.</p>
              <p className="font-medium text-forest pt-2 border-t border-forest/10">If the practice remains operational during construction, phasing and site access may need to be considered.</p>
            </div>
          </motion.div>
        </motion.div>
        ...
        <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-100px" }} variants={staggerContainer} className="grid grid-cols-1 md:grid-cols-2 gap-8 items-stretch">
           <motion.div variants={fadeIn} className="bg-sand rounded-[32px] p-10 sm:p-14 border border-white shadow-[0_8px_30px_rgb(0,0,0,0.02)]">
              <h2 className="font-display text-3xl sm:text-4xl text-forest mb-6 tracking-[-0.02em]">
                Materials for <br /><span className="italic text-terracotta">Veterinary Environments</span>
              </h2>
              <div className="text-[16px] leading-[1.8] text-forest-deep/90 font-light">
                <p className="mb-6">Animal hospitals experience frequent cleaning, moisture, traffic, and demanding daily use. For that reason, finishes should be selected with the intended application in mind. Relevant considerations can include:</p>
                <ul className="grid grid-cols-2 gap-y-3 gap-x-4 mb-6 text-[14px]">
                  {['Durability', 'Cleanability', 'Moisture resistance', 'Maintenance', 'Safety', 'Traffic', 'Long-term performance'].map((item, i) => (
                    <li key={i} className="flex items-center gap-2">
                       <span className="text-terracotta/60 w-1 h-1 rounded-full bg-terracotta flex-shrink-0"></span> {item}
                    </li>
                  ))}
                </ul>
                <p className="italic border-t border-forest/10 pt-6 text-[14px]">Different rooms may require different material approaches.</p>
              </div>
           </motion.div>

           <motion.div variants={fadeIn} className="bg-white/40 rounded-[32px] p-10 sm:p-14 border border-white">
              <h2 className="font-display text-3xl sm:text-4xl text-forest mb-6 tracking-[-0.02em]">
                Construction Cost in <br /><span className="italic text-terracotta">Essex County</span>
              </h2>
              <div className="text-[16px] leading-[1.8] text-forest-deep/90 font-light">
                <p className="mb-6">Veterinary construction costs vary by project and property. Factors can include:</p>
                <ul className="grid grid-cols-2 gap-y-3 gap-x-4 mb-6 text-[14px]">
                  {['Building size', 'New construction or renovation', 'Existing conditions', 'Number of clinical spaces', 'Surgical requirements', 'Plumbing & Electrical', 'HVAC', 'Flooring and finishes', 'Millwork', 'Equipment coordination', 'Accessibility', 'Permitting', 'Overall complexity'].map((item, i) => (
                    <li key={i} className="flex items-center gap-2">
                       <span className="text-olive w-1 h-1 rounded-full bg-olive flex-shrink-0"></span> {item}
                    </li>
                  ))}
                </ul>
                <p className="italic border-t border-forest/10 pt-6 text-[14px]">A site evaluation and defined scope are needed for a meaningful construction estimate.</p>
              </div>
           </motion.div>
        </motion.div>
        ...
        <div className="mx-auto max-w-4xl px-4 sm:px-8 text-center relative z-10">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={staggerContainer}>
            <motion.h2 variants={fadeIn} className="font-display text-[clamp(2.5rem,6vw,4.5rem)] text-linen mb-8 leading-[1.05] tracking-[-0.02em]">
              Veterinary Hospital Construction in <br className="hidden sm:block" /><span className="italic text-terracotta">Essex County</span>
            </motion.h2>
            <motion.div variants={fadeIn} className="space-y-6 text-[18px] sm:text-[20px] leading-[1.7] text-linen/70 mb-14 max-w-2xl mx-auto font-light">
              ...
              <p>Planning a new veterinary hospital, clinic build-out, renovation, or expansion? Contact Hevan M Constructions to discuss your project.</p>
            </motion.div>

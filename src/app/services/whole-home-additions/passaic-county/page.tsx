          ...
          <div className="lg:col-span-6">
            <motion.div variants={fadeIn} className="relative">
              ...
              <div className="space-y-6 text-[17px] leading-[1.8] text-forest-deep/80 font-light">
                <p>We provide home addition services in Passaic County, NJ, for homeowners looking to improve their living space through thoughtful, practical expansion.</p>
                <p>The right addition depends on how your household lives. Some homeowners need a larger gathering area, while others need privacy, workspace, or additional bedrooms.</p>
              </div>
            </motion.div>
          </div>
          <div className="lg:col-span-6">
            <motion.div variants={fadeIn} className="bg-white/50 backdrop-blur-sm p-10 rounded-[32px] border border-white shadow-sm">
              <h3 className="font-display text-2xl text-forest mb-6">Thoughtful Expansion</h3>
              <p className="text-[15px] leading-[1.7] text-forest-deep/80 font-light mb-6">A successful addition should improve the way the entire home functions. The design should consider how the new space connects to existing rooms, where natural light enters, how people move through the house, and how the addition relates to the home's exterior.</p>
              <p className="text-[15px] leading-[1.7] text-forest-deep/80 font-medium text-terracotta">The goal is a home that feels more spacious without losing its sense of continuity.</p>
            </motion.div>
          </div>
        </motion.div>
        ...
        <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-100px" }} variants={staggerContainer} className="bg-forest rounded-[40px] p-10 sm:p-16 lg:p-24 relative overflow-hidden shadow-2xl w-full">
          ...
          <div className="relative z-10">
            ...
            <motion.h2 variants={fadeIn} className="font-display text-[clamp(2.5rem,5vw,4.5rem)] leading-[1.05] text-linen mb-16 tracking-[-0.02em] max-w-2xl">
              Popular Addition Options <span className="italic text-terracotta">in Passaic County</span>
            </motion.h2>
            
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                { title: 'Kitchen Expansions', desc: 'Create more workspace, storage, and dining areas.' },
                { title: 'Family Room Additions', desc: 'Add comfortable space for everyday living and entertaining.' },
                { title: 'Primary Suite Additions', desc: 'Add a private bedroom, bathroom, and closet area.' },
                { title: 'Bedroom Additions', desc: 'Provide additional space for growing families or guests.' },
                { title: 'Home Office Additions', desc: 'Create a dedicated, functional work environment.' },
                { title: 'Second-Story Additions', desc: 'Add additional living space upstairs.' },
                { title: 'Rear or Side Additions', desc: 'Expand the existing footprint strategically.' },
              ].map((step, i) => (
        ...
        <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-100px" }} variants={staggerContainer} className="bg-linen rounded-[40px] p-10 sm:p-16 lg:p-24 relative overflow-hidden shadow-sm border border-white">
          <div className="max-w-4xl mx-auto text-center relative z-10">
            ...
            <motion.div variants={fadeIn} className="space-y-6 text-[17px] leading-[1.8] text-forest-deep/80 font-light mb-12">
              <p>Before construction begins, several property-specific questions should be answered. Local requirements can differ between municipalities, so planning should be based on the specific property and proposed scope.</p>
            </motion.div>

          ...
          <div className="lg:col-span-6">
            <motion.div variants={fadeIn} className="relative">
              ...
              <div className="space-y-6 text-[17px] leading-[1.8] text-forest-deep/80 font-light">
                <p>We provide residential home addition services throughout Essex County, NJ, including kitchen expansions, family rooms, bedrooms, primary suites, home offices, and second-story additions.</p>
                <p>Every home addition should respond to the property and the homeowner's needs. We consider the existing layout, architecture, natural light, circulation, structural requirements, and how the new space will connect with the rest of the home.</p>
              </div>
            </motion.div>
          </div>
          <div className="lg:col-span-6">
            <motion.div variants={fadeIn} className="bg-white/50 backdrop-blur-sm p-10 rounded-[32px] border border-white shadow-sm">
              <h3 className="font-display text-2xl text-forest mb-6">Designed to Feel Like Home</h3>
              <p className="text-[15px] leading-[1.7] text-forest-deep/80 font-light mb-6">A quality addition should look and function like part of the original house. Rooflines, windows, exterior materials, floor levels, finishes, lighting, HVAC, plumbing, and electrical systems all deserve consideration.</p>
              <p className="text-[15px] leading-[1.7] text-forest-deep/80 font-medium text-terracotta">The goal isn't simply to add square footage. It's to create useful, comfortable space that improves the entire home.</p>
            </motion.div>
          </div>
        </motion.div>
        ...
        <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-100px" }} variants={staggerContainer} className="bg-forest rounded-[40px] p-10 sm:p-16 lg:p-24 relative overflow-hidden shadow-2xl w-full">
          ...
          <div className="relative z-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                { title: 'Kitchen & Dining', desc: 'Create more room for cooking, storage, dining, and entertaining.' },
        ...
        <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-100px" }} variants={staggerContainer} className="bg-linen rounded-[40px] p-10 sm:p-16 lg:p-24 relative overflow-hidden shadow-sm border border-white">
          <div className="max-w-4xl mx-auto text-center relative z-10">
            ...
            <motion.div variants={fadeIn} className="space-y-6 text-[17px] leading-[1.8] text-forest-deep/80 font-light mb-12">
              <p>Consider these important aspects before breaking ground. Requirements can vary between Essex County municipalities, so the property and proposed project should be evaluated individually.</p>
            </motion.div>

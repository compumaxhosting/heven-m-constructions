      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-8 py-12 sm:py-20 space-y-32">
          ...
          <div className="lg:col-span-6">
            <motion.div variants={fadeIn} className="relative">
              ...
              <h2 className="font-display text-4xl sm:text-5xl text-forest mb-8 leading-[1.1] tracking-[-0.02em]">
                Custom Home <span className="italic text-terracotta">Additions</span>
              </h2>
              <div className="space-y-6 text-[17px] leading-[1.8] text-forest-deep/80 font-light">
                <p>We provide residential home addition services throughout Morris County, NJ, including kitchen expansions, family rooms, bedrooms, primary suites, home offices, and second-story additions.</p>
                <p>The right addition starts with understanding the existing home and the reason you need more space. Design considerations can include layout, architecture, natural light, circulation, structural requirements, and how the new space connects to the rest of the house.</p>
              </div>
            </motion.div>
          </div>
          <div className="lg:col-span-6">
            <motion.div variants={fadeIn} className="bg-white/50 backdrop-blur-sm p-10 rounded-[32px] border border-white shadow-sm">
              <h3 className="font-display text-2xl text-forest mb-6">An Addition That Belongs</h3>
              <p className="text-[15px] leading-[1.7] text-forest-deep/80 font-light mb-6">A quality addition should feel intentional—not attached as an afterthought. Rooflines, windows, exterior materials, floor elevations, finishes, lighting, HVAC, plumbing, and electrical systems all need to work together with the existing house.</p>
              <p className="text-[15px] leading-[1.7] text-forest-deep/80 font-medium text-terracotta">The objective is more than additional square footage. It's better space that improves how the entire home functions.</p>
            </motion.div>
          </div>
        </motion.div>
        ...
        <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-100px" }} variants={staggerContainer} className="bg-forest rounded-[40px] p-10 sm:p-16 lg:p-24 relative overflow-hidden shadow-2xl w-full">
          ...
          <div className="relative z-10">
            ...
            <motion.h2 variants={fadeIn} className="font-display text-[clamp(2.5rem,5vw,4.5rem)] leading-[1.05] text-linen mb-16 tracking-[-0.02em] max-w-2xl">
              Popular Addition Options <span className="italic text-terracotta">in Morris County</span>
            </motion.h2>
        ...
        <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-100px" }} variants={staggerContainer} className="bg-linen rounded-[40px] p-10 sm:p-16 lg:p-24 relative overflow-hidden shadow-sm border border-white">
          <div className="max-w-4xl mx-auto text-center relative z-10">
            <motion.h2 variants={fadeIn} className="font-display text-3xl sm:text-4xl text-forest mb-8 tracking-[-0.02em]">
              What to Consider <span className="italic text-terracotta">Before Building</span>
            </motion.h2>
            <motion.div variants={fadeIn} className="space-y-6 text-[17px] leading-[1.8] text-forest-deep/80 font-light mb-12">
              <p>Before starting a home addition, consider these important aspects. Requirements can vary among Morris County municipalities, so every property should be evaluated individually.</p>
            </motion.div>
            
            <motion.div variants={fadeIn} className="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-4 text-left">
              {[

...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: 'https://www.havenmconstruction.com/images/boutique-office-construction-essex-county-nj.jpg',
  ...
  twitter: {
    ...
    images: ['https://www.havenmconstruction.com/images/boutique-office-construction-essex-county-nj.jpg'],
  },
};

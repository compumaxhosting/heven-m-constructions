        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-8 text-center relative z-10">
          <motion.div initial="hidden" animate="visible" variants={staggerContainer} className="max-w-4xl mx-auto">
            ...
            <motion.h1 variants={fadeIn} className="font-display text-[clamp(2.5rem,6vw,5.5rem)] text-forest leading-[1.05] tracking-[-0.02em] mb-8">
              ...
              <span className="italic text-terracotta">Morris County</span>
            </motion.h1>
            ...
            <motion.p variants={fadeIn} className="text-[18px] sm:text-[22px] leading-[1.6] text-forest-deep/80 font-light mb-12 max-w-2xl mx-auto">
              Custom Commercial Spaces for Independent Businesses. A boutique office should be designed around the business inside it.
            </motion.p>
          </motion.div>
        </div>
      </section>
          ...
          <div className="lg:col-span-5">
            <motion.div variants={fadeIn} className="relative">
              ...
              <div className="space-y-6 text-[17px] leading-[1.8] text-forest-deep/80 font-light">
                <p>Haven M Construction provides boutique office construction and renovation services in Morris County, NJ, helping small businesses and professional firms create workspaces that combine practical function with a distinctive visual identity.</p>
                <p>Our boutique office construction services can include everything from professional renovations to custom commercial interiors.</p>
              </div>
            </motion.div>
          </div>
        ...
        <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-100px" }} variants={staggerContainer} className="bg-linen rounded-[40px] p-10 sm:p-16 lg:p-24 relative overflow-hidden shadow-sm border border-white">
          <div className="max-w-3xl mx-auto text-center relative z-10">
            ...
            <motion.div variants={fadeIn} className="space-y-6 text-[18px] leading-[1.8] text-forest-deep/80 font-light">
              <p>An office needs to accommodate more than desks. It may need to support focused work, private conversations, client meetings, presentations, collaboration, storage, and employee interaction—all within the same footprint. That makes space planning an important part of the construction process.</p>
              <p>A boutique workspace can reinforce the identity of your company through its physical environment. Materials, lighting, color, flooring, millwork, doors, partitions, and furnishings all contribute to the overall impression. The goal is not to make every office look luxurious. The goal is to create a space that feels intentional and appropriate for your business.</p>
            </motion.div>
          </div>
        </motion.div>
        ...
        <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-100px" }} variants={staggerContainer} className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          <motion.div variants={fadeIn}>
            ...
            <p className="text-[17px] leading-[1.8] text-forest-deep/80 font-light mb-8">
              An existing office may already have the location and basic infrastructure your business needs. A renovation can focus on changing what is not working. The scope should be based on the existing space and the desired outcome.
            </p>
            <h3 className="font-display text-2xl text-forest mb-6">A Better Office for a Growing Business</h3>
            <p className="text-[16px] leading-[1.8] text-forest-deep/80 font-light">
              As a company grows, the original office layout may no longer make sense. You may need additional private rooms, a larger conference area, more storage, or a better balance between individual and collaborative work. A targeted renovation can address those needs while keeping the business in a familiar location.
            </p>
          </motion.div>

          <motion.div variants={fadeIn} className="bg-white/50 backdrop-blur-sm p-10 rounded-[32px] border border-white shadow-sm">
            <h3 className="font-display text-2xl text-forest mb-8">Depending on the property, that could mean:</h3>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-y-4 gap-x-8">
              {[
                'Removing or adding partitions',
                'Creating private offices',
                'Improving reception',
                'Expanding meeting space',
                'Updating finishes',
                'Reworking lighting',
                'Improving storage',
        ...
        <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-100px" }} variants={staggerContainer} className="text-center max-w-3xl mx-auto">
           <motion.h2 variants={fadeIn} className="font-display text-3xl sm:text-4xl text-forest mb-6 tracking-[-0.02em]">
            ...
            <motion.p variants={fadeIn} className="text-[17px] leading-[1.8] text-forest-deep/80 font-light">
              The investment depends on the project. Important variables include office size, existing layout, demolition, new partitions, electrical, lighting, HVAC, plumbing, flooring, millwork, finish materials, fixtures, permit requirements, and project complexity. An accurate estimate requires an understanding of the actual space and proposed improvements.
            </motion.p>
        </motion.div>
        ...
        <div className="mx-auto max-w-4xl px-4 sm:px-8 text-center relative z-10">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={staggerContainer}>
            <motion.h2 variants={fadeIn} className="font-display text-[clamp(2.5rem,6vw,4.5rem)] text-linen mb-8 leading-[1.05] tracking-[-0.02em]">
              Boutique Office Construction in <br className="hidden sm:block" /><span className="italic text-terracotta">Morris County</span>
            </motion.h2>
            ...
            <motion.div variants={fadeIn} className="mb-16">
              <p className="text-[17px] text-linen font-medium mb-8">If your current office no longer fits your business...</p>

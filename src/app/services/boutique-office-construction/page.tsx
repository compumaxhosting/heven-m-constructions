...
export default function BoutiqueOfficeConstructionPage() {
          ...
          <div className="relative z-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
              {[
                ...
                { title: 'Space Evaluation', desc: 'The existing space is reviewed to understand its layout, condition, infrastructure, and potential limitations.' },
                { title: 'Planning & Design', desc: 'The proposed layout, finishes, materials, and construction requirements are developed around your business needs.' },
                { title: 'Scope & Estimate', desc: 'The project scope is defined and the expected construction requirements and costs are evaluated.' },
                { title: 'Pre-Construction', desc: 'Scheduling, materials, permits, inspections, and other project details are coordinated as required.' },
        ...
        <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-100px" }} variants={staggerContainer} className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20">
          <div className="lg:col-span-5">
            <motion.div variants={fadeIn} className="sticky top-32 lg:pr-8">
              ...
              <p className="text-[17px] sm:text-[19px] leading-[1.7] text-forest-deep/80 font-light mb-8">
                Everything you need to know about our boutique office construction and renovation process, tailored for your business.
              </p>
            </motion.div>
          </div>
          ...
          <div className="lg:col-span-7">
            <div className="border-t border-forest/15">
              {[
                { q: 'What is boutique office construction?', a: 'Boutique office construction focuses on creating a distinctive, functional professional workspace tailored to a specific business rather than using a generic office layout.' },
                { q: 'Can you renovate an existing office?', a: 'Yes. An existing commercial space can often be renovated and reconfigured to create private offices, meeting rooms, reception areas, workspaces, and other business functions.' },
                { q: 'Can you build an executive office?', a: 'Yes. Executive offices can be incorporated into a larger office renovation or developed as part of a dedicated commercial interior project.' },
                { q: 'Can you create a creative studio?', a: 'Yes. Creative studios can be planned around the workflow, equipment, lighting, storage, collaboration, and client interaction required by the business.' },
                { q: 'How much does a boutique office renovation cost?', a: 'The cost depends on the size, existing condition, design, materials, building systems, finishes, and construction requirements. A project-specific estimate is more meaningful than a generic price.' },
                { q: 'Do commercial office renovations require permits?', a: 'Many commercial construction projects require permits, but requirements vary according to the work, property, and municipality. Applicable requirements should be determined during project planning.' },
                { q: 'How do I start a boutique office project?', a: 'Begin with a consultation. Share your business needs, property location, approximate space requirements, and goals for the finished office.' },
              ].map((faq, i) => {

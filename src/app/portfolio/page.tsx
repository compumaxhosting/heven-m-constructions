...
export default function PortfolioPage() {
  ...
  // Ensure navHeight is accurate when the filter becomes fixed (header may change height)
  useEffect(() => {
    ...
    <main>
      ...
      >
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-8">
          ...
          <p className="mt-8 max-w-xl text-lg leading-relaxed text-forest-deep">
            Five recent projects across residential renovation, veterinary, and
            boutique commercial work.
          </p>
        </div>
      </section>
      ...
      <section
        ...
        className={`bg-linen/95 py-4 border-b border-forest/10 z-40 backdrop-blur-sm transition-shadow duration-300 ${
          filterFixed ? "left-0 right-0 shadow-md" : "relative"
        }`}
      >
